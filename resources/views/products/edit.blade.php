                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="product-name"
                                         ...
                                         value="{{ old('product-name') ?? $product->product_name }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="product-description" 
                                        ...
                                        required>{{ old('product-description') ?? $product->product_description }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="product-price" 
                                        ...
                                        value="{{ old('product-price') ?? $product->product_price }}" required>
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="product-image" 
                                                name="product-image" value="{{ old('product-image') }}">
